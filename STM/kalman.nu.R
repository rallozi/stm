...
`kalman.nu` <-
  function (z, dist, r, tp, n, p, phi_j, covariates, SigmaEta, dQdnu_j, learning.rate) {
    ...
    nu_jj<- phi_j$nu-learning.rate*(1/(d2Qd2nu_jj))*dQdnu_jj
    NR_jj<- c(phi_j$b, nu_jj, phi_j$s)
    ...
    return(list(phi=phi_jj, likelihood=loglik_jj, dQdnu_j=dQdnu_jj))
  }
