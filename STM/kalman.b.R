...
`kalman.b` <-
  function (z, dist, r, tp, n, p, phi_j, covariates, SigmaEta, dQdgamma_j, learning.rate) {
    ...
    b_jj<- phi_j$b - learning.rate*(1/(d2Qd2gamma_jj))*dQdgamma_jj
    NR_jj<- c(b_jj, phi_j$nu, phi_j$s)
    ...
    return(list(phi=phi_jj, likelihood=loglik_jj, dQdgamma_j=dQdgamma_jj))
  }
